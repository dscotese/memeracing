...
<li><h3>What's a meme?</h3>
    ...
    sometimes getting better and sometimes worse.  It's an idea or concept.</li>
<li><h3>What is a meme race?</h3>
    ...
    collected into batches of seven, and the seven respondents of those responses are
...
<li><h3>How do I earn bitcoin without spending any?</h3>
    ...
    providing an answer that inspired someone to back it.</li>
<li><h3>What if I'm willing to risk some bitcoin?</h3>
    ...
    bitcoin you send us to back it will be allocated to that answer.  After you hit
    ...
    and this is where half of the deducted percentage goes.  The other half is divided between the
...
<li><h3>How do you win?</h3>
    Each respondent that has an answer in a contest gets a chance to order all the answers.  The system provides
    an individualized random order for anyone who doesn't change it before the deadline
...
<li><h3>If someone earns a very small amount, how do you cover the transaction fee?</h3>
    We won't send bitcoin to an address until we owe that address more than 0.01 BTC.
